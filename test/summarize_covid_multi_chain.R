...
analysis_dirs <- paste0("./analysis_covid_seed_",seeds,"/")
...
summary_dir <- paste0("multi_chain_covid_summary_seeds_",min(seeds),"_",max(seeds))
...
save(forest_plot_dat,file="forest_plot_dat.RData")
