...
// rjmcmc_r
void rjmcmc_r(std::string output_dir, std::vector<int> index_arg, std::vector<double> viral_load_arg, std::vector<double> time_arg, std::vector<int> subtype_arg, std::vector<double> t_first_positive_arg, std::vector<double> t_last_positive_arg, std::vector<double> t_first_test_arg, std::vector<double> t_last_test_arg, std::vector<double> t_last_negative_before_arg, std::vector<double> t_first_negative_after_arg, std::vector<int> n_positive_tests_arg, std::vector<double> max_viral_load_arg, double lod_arg, double sensitivity_arg, int n_iterations_arg, int n_subtypes_arg, int n_subjects_arg, int n_data_arg, std::vector<double> wp_current_arg, std::vector<double> tp_current_arg, std::vector<double> dp_current_arg, std::vector<double> wr_current_arg, std::vector<int> model_current_arg, double sigma_arg, std::vector<double> wp_mean_arg, std::vector<double> wp_sd_arg, std::vector<double> tp_sd_arg, std::vector<double> dp_mean_arg, std::vector<double> dp_sd_arg, std::vector<double> wr_mean_arg, std::vector<double> wr_sd_arg, std::vector<double> priors_vec, std::vector<double> wp_mean_sf_arg, std::vector<double> wp_sd_sf_arg, std::vector<double> tp_sd_sf_arg, std::vector<double> dp_mean_sf_arg, std::vector<double> dp_sd_sf_arg, std::vector<double> wr_mean_sf_arg, std::vector<double> wr_sd_sf_arg, double sigma_sf_arg, double wp_sf_arg, double tp_sf_arg, double dp_sf_arg, double wr_sf_arg, double seed_arg);
RcppExport SEXP _ViralLoadRJMCMC_rjmcmc_r(SEXP output_dirSEXP, SEXP index_argSEXP, SEXP viral_load_argSEXP, SEXP time_argSEXP, SEXP subtype_argSEXP, SEXP t_first_positive_argSEXP, SEXP t_last_positive_argSEXP, SEXP t_first_test_argSEXP, SEXP t_last_test_argSEXP, SEXP t_last_negative_before_argSEXP, SEXP t_first_negative_after_argSEXP, SEXP n_positive_tests_argSEXP, SEXP max_viral_load_argSEXP, SEXP lod_argSEXP, SEXP sensitivity_argSEXP, SEXP n_iterations_argSEXP, SEXP n_subtypes_argSEXP, SEXP n_subjects_argSEXP, SEXP n_data_argSEXP, SEXP wp_current_argSEXP, SEXP tp_current_argSEXP, SEXP dp_current_argSEXP, SEXP wr_current_argSEXP, SEXP model_current_argSEXP, SEXP sigma_argSEXP, SEXP wp_mean_argSEXP, SEXP wp_sd_argSEXP, SEXP tp_sd_argSEXP, SEXP dp_mean_argSEXP, SEXP dp_sd_argSEXP, SEXP wr_mean_argSEXP, SEXP wr_sd_argSEXP, SEXP priors_vecSEXP, SEXP wp_mean_sf_argSEXP, SEXP wp_sd_sf_argSEXP, SEXP tp_sd_sf_argSEXP, SEXP dp_mean_sf_argSEXP, SEXP dp_sd_sf_argSEXP, SEXP wr_mean_sf_argSEXP, SEXP wr_sd_sf_argSEXP, SEXP sigma_sf_argSEXP, SEXP wp_sf_argSEXP, SEXP tp_sf_argSEXP, SEXP dp_sf_argSEXP, SEXP wr_sf_argSEXP, SEXP seed_argSEXP) {
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< std::vector<double> >::type t_last_negative_before_arg(t_last_negative_before_argSEXP);
    Rcpp::traits::input_parameter< std::vector<double> >::type t_first_negative_after_arg(t_first_negative_after_argSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    {"_ViralLoadRJMCMC_rjmcmc_r", (DL_FUNC) &_ViralLoadRJMCMC_rjmcmc_r, 46},
