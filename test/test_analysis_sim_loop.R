...
for(seed_i in seeds){
  print(paste0("Analysis for seed", seed_i))
  setwd("~/Documents/Research/Within-Host/RJMCMC_Results")
  ...
  wp_init <- rep(3,nrow(individual_data))
  dp_init <- rep(25,nrow(individual_data))
  tp_init <- rep(0,nrow(individual_data))
  wr_init <- rep(5,nrow(individual_data))
